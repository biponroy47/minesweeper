...
# Project:  main.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile main.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = main1.0.0
DISTDIR = /Users/biponroy/Downloads/CS3307/minesweeper/.tmp/main1.0.0
...
EXPORT__QMAKE_STASH_ = /Users/biponroy/Downloads/CS3307/minesweeper/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/biponroy/Downloads/CS3307/minesweeper/main.pro
...
Makefile: main.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
...
main.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,bipon.main,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},bipon.main,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,main,g" -e "s,@LIBRARY@,main,g" -e "s,\$${EXECUTABLE_NAME},main,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >main.app/Contents/Info.plist
